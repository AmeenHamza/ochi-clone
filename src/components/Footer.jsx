...
function Footer() {
    return (
        <>
            <div className='w-full font-founders-grotesk flex gap-5 h-auto p-20 bg-zinc-900'>
                <div className="w-1/2 flex flex-col justify-between h-full">
                    <div className="heading">
                        <h1 className='text-8xl leading-none font-bold -tracking-[0.4rem]'>EYE-</h1>
                        <h1 className='text-8xl leading-none font-bold -tracking-[0.4rem] -mt-3'>OPENING</h1>
                    </div>
                </div>
                <div className="w-1/2">
                    <h1 className='text-7xl leading-none font-bold tracking-tighter'>PRESENTATIONS</h1>
                    <div className="links mt-10">
                        <h4>S:</h4>
                        <div className='mt-5 underline underline-offset-4 text-lg'>
                            <h4>Instagram</h4>
                            <h4>Facebook</h4>
                            <h4>Behance</h4>
                            <h4>Linkedin</h4>
                    ...
                    <div className="location w-full flex justify-between">
                        <div className="links mt-10">
                            <h4>L:</h4>
                            <div className='mt-5 underline underline-offset-4 text-lg'>
                                <h4>Instagram</h4>
                    ...
                    <div className="links mt-10">
                        <h4>E:</h4>
                        <div className='mt-2 underline underline-offset-4 text-lg'>
                            <h4>hello@ochi.design</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div className="copyright  flex justify-between py-5 px-5 items-center w-full">
                <div>
                ...
                <div className='text-white/40'>&copy;  ochi design 2024. Legal Terms</div>
                <div className='text-white/40'>Website by Obys</div>
            </div>
        </>
    )
}
